...
۴. روی همان گزینه **2-Step Verification** کلیک کنید، به پایین صفحه اسکرول کنید و روی **App passwords** کلیک کنید.
...
* **SMTP Server:** `://gmail.com` *(دقت کنید که هیچ علامت اضافه‌ای مثل `://` یا `/` در ابتدا و انتهای آن نباشد)*
* **Port:** `587`
