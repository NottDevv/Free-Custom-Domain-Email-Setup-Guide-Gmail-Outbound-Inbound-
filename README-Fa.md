...
۵. یک پنجره پاپ‌آپ زرد رنگ باز می‌شود، اطلاعات را به شکل زیر وارد کنید:
   * <div dir="ltr" align="left">**Name:** Your name or business name (e.g., `John Doe`).</div>
   * <div dir="ltr" align="left">**Email address:** Your custom domain email address (e.g., `info@yourdomain.com`).</div>
...
* <div dir="ltr" align="left">**SMTP Server:** `smtp.gmail.com`</div>
* <div dir="ltr" align="left">**Port:** `587`</div>
* <div dir="ltr" align="left">**Username:** Your full personal Gmail address (`youraccount@gmail.com`)</div>
* <div dir="ltr" align="left">**Password:** The **16-character App Password** you generated in Step 1.</div>
* <div dir="ltr" align="left">**Secured connection using TLS (recommended)** را برای نوع اتصال انتخاب کنید.</div>
